(function ($) {
    ...
    $('#boton-buscar-vehiculo').click(function (e) {
        ...
        if ($('#select-ciudad').find(":selected").val() > 0) {
            if ($('#fechaDevolucion').val() === '') {
                ...
                $.post('/data/vehiculos', data, function (response) {
    ...
    $('#boton-guardar').click(function (e) {
        ...
        if ($('#fechaDevolucion').val() === '') {
            ...
            if ($('#select-vendedor').find(":selected").val() > 0) {
                var data = 'idVendedor' + $('#select-vendedor').find(":selected").val() +
                ...
                $.post('/reservas/crear', data, function (response) {
    ...
    $.post('/data/vendedores', null, function (response) {
    ...
    $.post('/data/paises', null, function (response) {
    ...
    $.post('/data/lugares', null, function (response) {
